...
elseif($cobertura=="TERCEROS CON GRUA PICKUP"){
	...
	$robo="ROBO TOTAL"."			        NO APLICA"."		     NO APLICA";
	$dano="DA&Ntilde;OS MATERIALES"."		NO APLICA"."		     NO APLICA ";
	$gastos="GASTOS MEDICOS OCUPANTES"."	 $100,000"."             NO APLICA";
	$med="GASTOS MEDICOS CONDUCTOR"."	    NO APLICA"."             NO APLICA";
    $asis="ASESORIA LEGAL"."                  Amparada"."            NO APLICA"    ; 
    $cristal="CRISTALES"."			        NO APLICA"."		     NO APLICA";
	$vial="ASISTENCIA VIAL"."	    1 GRUA PO AÑO MAXIMO 50 KM"."	 NO APLICA";
	$muerte="MUERTE CONDUCTOR"."			 $80,000.00"."		     NO APLICA";
}
...
elseif($cobertura=="AMPLIA PICKUP HASTA $120,000"){
	...
	$dano="DA&Ntilde;OS MATERIALES"."		  Amparada"."		  5% VALOR COMERCIAL";
	$gastos="GASTOS MEDICOS OCUPANTES"."	 $120,000.00"."          NO APLICA";
	$med="GASTOS MEDICOS CONDUCTOR"."	      NO APLICA"."           NO APLICA";
    $asis="ASESORIA LEGAL"."                  Amparada"."            NO APLICA"    ; 
    $cristal="CRISTALES"."			          NO APLICA"."		        20%";
	$vial="ASISTENCIA VIAL"."	     2 GRUAS POR AÑO MAXIMO 50KM "."	NO APLICA";
...
$desglose="";
  ...
  $query1 = "SELECT * FROM datos   WHERE placas='$placas' and serie='$serie'   ";
	...
	if($placas2=="" and $serie2=="")
{
	...
	if($cobertura=="AMPLIA" or $cobertura=="INTERMEDIA" or $cobertura=="INTERMEDIA Motos" or $cobertura=="AMPLIA Motos" ){
	
	$query1 = " INSERT INTO `mutua036_cruz`.`datos` (
...
`ediciones` ,
`fecha_modificacion` ,
`desglose`,`vendedor`,`cobrador`,`ano2`,`uno`,`dos`,`tres`,`cuatro`,`cinco`,`seis`,`siete`,`ocho`,`nueve`,`diez`,`tel2`,`costo_letra`,`asis`,`robo`,`dano`,`cristal`,`rca`,`gastos`,`grua`,`plataforma`)
VALUES ('$nombre',
'$domicilio ',
'$exterior ',
'$entre ',
...
'$ediciones ',
'$fecha_modificacion ',
'$desglose','$vendedor','$cobrador','$ano2','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','$tel2','$costo_letra','$asis','$robo','$dano','$cristal','$rca','$gastos','$grua','$plataforma')";
	
	
	$result = mysqli_query($conexion,$query1);
	mysqli_free_result($result);
	}
	elseif($cobertura=="A Terceros" or $cobertura=="A Terceros2" or $cobertura=="A Terceros3" or $cobertura=="A Terceros4" or $cobertura=="A Terceros Motoe" or $cobertura=="A Terceros2 Motos" or $cobertura=="A Terceros3 Motos" or $cobertura=="A Terceros4 Motos" ){
...
'$ediciones ',
'$fecha_modificacion ',
'$desglose','$vendedor','$cobrador','$ano2','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','Pendiente','No Aplica','No Aplica','$tel2','$costo_letra','$asis','$robo','$dano','$cristal','$rca','$gastos','$grua','$plataforma')";

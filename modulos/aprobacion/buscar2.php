...
<body>
 ...
 <img src="../../logop.png" width="232" height="220">
	<form id="form1" name="form1" method="post" action="aprobacion.php">
	<div class="container">
		<div class="row">
			<div class="col-6 push-3">
				
				<div class="panel_head">
					<p class="titulo_panel"style="font-family:Broadway;" aling="center">INGRESA EL FOLIO DE LA POLIZA </p>
				</div>

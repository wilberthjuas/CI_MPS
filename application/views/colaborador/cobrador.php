...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="sticky">
							...
							<div class="card">
								<div class="card-body" style="background-color: #FFFFFF;">
									<div class="m-sm-4">
								        ...
								        <?php } ?>
								        <form method="post" action="<?php echo base_url('Colaboradores/actcfs');?>" id="registerForm">
											<div class="mb-3">
												<label class="form-label">
													<strong style="color: #000000;">Usuario</strong>
												</label>
												<input style="background-color: #FFFFFF; color: #000000;" class="form-control form-control-lg" type="email" name="user" autocomplete="off" readonly required 
	...
	function myFunction() {
		...
		if(band && myInput.value == pw2.value){

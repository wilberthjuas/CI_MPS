<div class="card">
    ...
    <br/>
    <div class="card-body">
        <form method="post" action="<?php echo base_url('tallerCRUDCreate');?>">
            <?php
            ...
            <div class="row">
                <div class="mb-3 col-md-4">
                    ...
                    <input autocomplete="off" type="email" name="email" class="form-control" maxlength="100"/>
                </div>
                <div class="mb-3 col-md-4">
                    <label class="form-label">
                        <strong>Página</strong>
                    </label>
                    <input autocomplete="off" type="text" name="pagina" class="form-control" maxlength="200"/>
                </div>
            </div>
            <div class="row">
                <div class="mb-3 col-md-4">
